...
export default function Home() {
  ...
  const projects = [
    ...
    {
      title: 'Brckt',
      description: 'Production RAG system for real-time tennis analytics at Brckt.io (fantasy tennis platform). Owned entire AI system end-to-end: built 5-stage pipeline (query routing → reformulation → hybrid retrieval → completion check → streaming generation), implemented Playwright web scraping for 27 tournaments, and reduced LLM response latency from 3s to 400ms (7.5x faster) using chunked streaming + model quantization. Integrated with frontend/backend team via FastAPI endpoints. Qdrant vector search handles head-to-head data for all Grand Slams + ATP/WTA 1000s.',
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b]">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${mounted ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'}`}>
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden fixed inset-0 top-20 bg-[#0a0a0b] z-40">
      ...
      <main className="page-transition">
            ...
            <div>
              <div className={`transition-all duration-700 delay-100 ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                ...
                <div className="flex items-center gap-3 mb-6">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 hover:bg-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/20">
              ...
              {projects.map((project, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-[16/10] md:aspect-auto md:h-[180px] bg-zinc-950/80 group-hover:bg-zinc-900 rounded-xl border border-zinc-800/50 group-hover:border-zinc-700 p-4 overflow-hidden transition-all duration-300 group-hover:scale-[1.02]">
                      <DiagramComponent />
                    </div>
                    ...
                    <div className="flex flex-col">
                      <div className="flex items-start justify-between gap-4 mb-3">
                        <div className="flex items-center gap-3">
                          <span className="text-zinc-600 text-[13px] font-mono group-hover:text-emerald-500 transition-colors duration-300">0{idx + 1}</span>
                          <h3 className="text-xl font-medium text-zinc-100 group-hover:text-white transition-colors">
                            {project.title}
                          </h3>
                        </div>
                        {/* Metric Badge */}
                        <div className="text-right shrink-0 group-hover:scale-105 transition-transform duration-300">
                          <div className="text-4xl font-bold text-emerald-400 font-mono leading-none group-hover:text-emerald-300 transition-colors">{project.metric}</div>
                      ...
                      <div className="flex items-center gap-3">
                        {project.demo && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-[13px] font-medium transition-all duration-200 hover:scale-105 active:scale-95 hover:shadow-lg hover:shadow-emerald-600/50"
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div key={exp.company}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.highlights.map((highlight) => (
                          <span
                            key={highlight}
                            className="text-[11px] text-emerald-400 px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20"
                          >
                            {highlight}
                          </span>
                        ))}
        ...
        <section className="py-24">
          <div className="max-w-screen-lg mx-auto px-6 md:px-12">
            ...
            {/* ML & AI */}
            <div className="mb-12">
              <p className="text-zinc-400 text-[12px] tracking-wide uppercase mb-6 text-center">ML & AI</p>
              <div className="flex flex-wrap justify-center gap-8 md:gap-10">
                {/* Python */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#3776AB] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 255" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">Python</span>
                </div>
                {/* PyTorch */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#EE4C2C] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 310" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">PyTorch</span>
                </div>
                {/* TensorFlow */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#FF6F00] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 274" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">TensorFlow</span>
                </div>
                {/* LangChain */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-emerald-400 hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">LangChain</span>
                </div>
                {/* Hugging Face */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#FFD21E] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 256" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500 whitespace-nowrap">Hugging Face</span>
                </div>
                {/* OpenAI */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-white hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">OpenAI</span>
                </div>
                {/* Anthropic/Claude */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#D4A574] hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.304 3.541l-5.296 16.918h-3.208L14.096 3.54h3.208zm-10.608 0L1.4 20.459h3.208L9.904 3.54H6.696z"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">Claude</span>
                </div>
                {/* Ollama */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-zinc-300 hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                    <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none"/>
                    <circle cx="12" cy="12" r="4" fill="currentColor"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">Ollama</span>
                </div>
              </div>
            </div>
            ...
            {/* Infrastructure */}
            <div className="mb-12">
              <p className="text-zinc-400 text-[12px] tracking-wide uppercase mb-6 text-center">Infrastructure</p>
              <div className="flex flex-wrap justify-center gap-8 md:gap-10">
                {/* FastAPI */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#009688] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 256" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">FastAPI</span>
                </div>
                {/* Docker */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#2496ED] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 185" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">Docker</span>
                </div>
                {/* AWS */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#FF9900] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 153" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">AWS</span>
                </div>
                {/* GCP */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 hover:scale-110 transition-transform duration-300" viewBox="0 0 256 206" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">GCP</span>
                </div>
                {/* Kubernetes */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#326CE5] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 249" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">Kubernetes</span>
                </div>
                {/* PostgreSQL */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#336791] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 264" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">PostgreSQL</span>
                </div>
                {/* Redis */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#DC382D] hover:scale-110 transition-transform duration-300" viewBox="0 0 256 220" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">Redis</span>
                </div>
                {/* Kafka */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-zinc-300 hover:scale-110 transition-transform duration-300" viewBox="0 0 256 416" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">Kafka</span>
                </div>
              </div>
            </div>
            ...
            {/* Vector DBs & Data */}
            <div>
              <p className="text-zinc-400 text-[12px] tracking-wide uppercase mb-6 text-center">Vector DBs & Data</p>
              <div className="flex flex-wrap justify-center gap-8 md:gap-10">
                {/* Pinecone */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#000000] hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                    <circle cx="12" cy="12" r="10" fill="#0F9D58"/>
                    <path d="M12 6v12M8 10l4-4 4 4M8 14l4 4 4-4" stroke="white" strokeWidth="2" fill="none"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">Pinecone</span>
                </div>
                {/* Qdrant */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#DC244C] hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">Qdrant</span>
                </div>
                {/* Weaviate */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#00D1B2] hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 3l6 3-6 3-6-3 6-3zm-7 5l7 3.5 7-3.5v6l-7 3.5-7-3.5v-6z"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">Weaviate</span>
                </div>
                {/* ChromaDB */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                    <circle cx="8" cy="8" r="5" fill="#FF6B6B"/>
                    <circle cx="16" cy="8" r="5" fill="#4ECDC4"/>
                    <circle cx="12" cy="15" r="5" fill="#FFE66D"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">ChromaDB</span>
                </div>
                {/* MLflow */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#0194E2] hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">MLflow</span>
                </div>
                {/* Weights & Biases */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-[#FFBE00] hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M4 4h4v4H4V4zm6 0h4v4h-4V4zm6 0h4v4h-4V4zM4 10h4v4H4v-4zm6 0h4v4h-4v-4zm6 0h4v4h-4v-4zM4 16h4v4H4v-4zm6 0h4v4h-4v-4zm6 0h4v4h-4v-4z"/>
                  </svg>
                  <span className="mt-2 text-[10px] text-zinc-500">W&B</span>
                </div>
                {/* GitHub */}
                <div className="group relative flex flex-col items-center">
                  <svg className="w-9 h-9 text-white hover:scale-110 transition-transform duration-300" viewBox="0 0 256 250" fill="currentColor">
                  ...
                  <span className="mt-2 text-[10px] text-zinc-500">GitHub</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className={`transition-all duration-700 ${contactSection.isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                ...
                <div className="flex items-center gap-6 mt-10 pt-10 border-t border-zinc-800">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group inline-flex items-center gap-2 text-[13px] text-zinc-400 hover:text-zinc-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-zinc-900 rounded px-2 py-1 -mx-2"
                  >
