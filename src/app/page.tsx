...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <div className="fixed bottom-0 left-10 hidden lg:block z-10">
        <div className="flex flex-col items-center gap-6 after:content-[''] after:block after:w-[1px] after:h-24 after:bg-slate/30">
          <a
      ...
      {/* Right sidebar - Email */}
      <div className="fixed bottom-0 right-10 hidden lg:block z-10">
        <div className="flex flex-col items-center gap-6 after:content-[''] after:block after:w-[1px] after:h-24 after:bg-slate/30">
          <a
            href="mailto:ayushkumarmalik10@gmail.com"
            className="[writing-mode:vertical-lr] text-slate hover:text-green hover:-translate-y-1 transition-all duration-300 font-mono text-sm"
          >
